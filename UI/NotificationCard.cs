...
namespace Ghost.Gw2EventTracker.UI {
    ...
    internal class NotificationCard : Container {
        ...
        public NotificationCard(string title, AsyncTexture2D icon, string message, string? tooltip = null) {
            _icon = icon;
            ...
            var wrappedTitle = DrawUtil.WrapText(Content.DefaultFont14, title, Width - CardHeight - 20);
            _ = new Label {
                Parent = this,
                Location = new Point(CardHeight + 10, 5),
                Size = new Point(Width - CardHeight - 10, Height / 2),
                Font = Content.DefaultFont14,
                BasicTooltipText = BasicTooltipText,
                Text = wrappedTitle
            };

            var wrappedMessage = DrawUtil.WrapText(Content.DefaultFont14, message, Width - CardHeight - 20);
            _ = new Label {
                Parent = this,
